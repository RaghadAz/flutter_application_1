...
import 'package:flutter_application_1/presentation/resources/styles_manager.dart';
...
//text theme
    textTheme: TextTheme(
      ...
      titleMedium:
          getLightStyle(color: ColorManager.lightGrey, fontSize: FontSize.s14),
      bodyLarge: getRegularStyle(color: ColorManager.grey1),
      bodySmall: getRegularStyle(color: ColorManager.grey),
    ),
//input decoration theme(tex form field)
...
//label style
      labelStyle:
          getLightStyle(color: ColorManager.grey, fontSize: FontSize.s14),
